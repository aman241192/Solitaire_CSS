$(document).ready(function () {
  ...
  jQuery(".faq_box_question__question").on("click", function () {
    jQuery(".faq_box_question__question").find(".clock_wrap").removeClass("active");
    if (jQuery(this).find(".clock_wrap").hasClass("active")) {
      jQuery(this).find(".clock_wrap").removeClass("active");
    } else {
      jQuery(this).find(".clock_wrap").addClass("active");
    }
  });
